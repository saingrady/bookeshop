    ...
    <div class="post">
        <div class="post-bgtop">
            <div class="post-bgbtm">
                <div align="center">
                    <br/>
                    <h1><s:text name="web.catalogue.title"/></h1><br/>
                    <display:table name="books" uid="book" sort="list" defaultorder="descending" requestURI="catalogue.do" class="dttable">
                        ...
                        <display:column property="title" title='<s:text name="web.book.title"/>' sortable="true"/>
                        <display:column title='<s:text name="web.book.author"/>' sortable="true">
